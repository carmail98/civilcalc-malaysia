  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const res = await fetch("/api/register", {
      ...
      body: JSON.stringify({
        ...
        bemNumber: form.bemNumber || undefined,
    ...
    <div className="flex justify-center py-4">
      <div className="w-full max-w-lg">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors mb-2"
        >
