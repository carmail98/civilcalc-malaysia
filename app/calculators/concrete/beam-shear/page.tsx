      ...
      <div className="print:hidden">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div>
            ...
            <h3 className="text-xs font-semibold uppercase tracking-wide text-gray-500 mb-3 mt-4">Links Provided (optional)</h3>
          ...
          <div className="space-y-4">
            {result ? (
              <>
                <h3 className="text-xs font-semibold uppercase tracking-wide text-gray-500">Intermediate Values</h3>
                ...
                <h3 className="text-xs font-semibold uppercase tracking-wide text-gray-500 pt-2">Shear Reinforcement</h3>
                ...
                {hasLinks && result.VRds !== null && (
                  <>
                    <h3 className="text-xs font-semibold uppercase tracking-wide text-gray-500 pt-2">Utilisation Check</h3>
